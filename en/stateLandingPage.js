...
const stateLandingPageTranslation = {
  ...
  features_special: {
    ca: {
      ...
      voting_info: {
        message: '<a href="/en/ca/ballot/election/area/39/section/voting-info?id=ocd-division/country:us/state:ca#menu-item-how-to-vote-in-the-presidential-primary">Get more Voting Info on where, when, and how to vote.</a>',
