...
const searchErrorsTranslation = {
    ...
    noElectionsErrorMessage: {
      ...
      ny: '<p>Voter’s Edge covers only California, Illinois, and New York for 2016. We look forward to expanding our coverage to new states in the future.</p><p>Your state and local election offices are the ultimate authority on elections in your area and <a href="/ny/ballot/election/area/45/section/voting-info?id=statewide-45-ny#section-election-office-contact">can be contacted</a> with additional questions.</p><p>You may also <a href="/ny/contact-us">contact us</a> if you believe you are receiving this message in error or have questions about our coverage.</p>', // Translate
