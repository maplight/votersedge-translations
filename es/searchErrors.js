...
const searchErrorsTranslation = {
    ...
    noElectionsErrorMessage: {
      ...
      ny: '<p>No encontramos ninguna elección próxima con base en la información proporcionada.</p><p>Sus oficinas de elecciones estatales y locales son la autoridad máxima en las elecciones en su área y <a href="/es/ny/ballot/election/area/44/section/voting-info?id=statewide-44-ny#section-election-office-contact">puede contactarlas</a> si tiene preguntas adicionales.</p><p>También <a href="/es/ny/contact-us">puede comunicarse con nosotros</a> si piensa que recibió este mensaje por error o si tiene preguntas sobre nuestra cobertura.</p>', // Translate
