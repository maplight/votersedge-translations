    ...
    fundingTranslation: {
      ...
      pieCharts: {
        byState: {
          label: 'Por estado:',
          tooltip: {
            "Federal": 'Esta gráfica muestra los estados principales de donde provinieron los fondos que se contribuyeron a este iniciativa de ley. La categoría con el texto "otros" representa el monto total del financiamiento que se contribuyó en otras partes de los Estados Unidos.',
            "State": {
              ca: 'Esta gráfica muestra los estados principales de donde provinieron los fondos que se contribuyeron a este iniciativa de ley. La categoría con el texto "otros" representa el monto total del financiamiento que se contribuyó en otras partes de los Estados Unidos.',
              ny: 'Esta gráfica muestra los estados principales de donde provinieron los fondos que se contribuyeron a este iniciativa de ley. La categoría con el texto "otros" representa el monto total del financiamiento que se contribuyó en otras partes de los Estados Unidos.',
              il: 'Esta gráfica muestra los estados principales de donde provinieron los fondos que se contribuyeron a este iniciativa de ley. La categoría con el texto "otros" representa el monto total del financiamiento que se contribuyó en otras partes de los Estados Unidos.',
            }
          },
